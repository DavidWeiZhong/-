...
import com.example.lcit.davidlibrary.R;


/**
 * Created by 邱伟中 on 2016/4/14.
 * 弹出提示的对话框，退出当前账号？
 */
public class WarnDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public WarnDialog create() {
            ...
            final WarnDialog dialog = new WarnDialog(context, R.style.Dialog);
            ...
            if (negativeButtonText != null) {
                ...
                if (positiveButtonText != null) {
                    ((Button) layout.findViewById(R.id.positiveButton)).setBackgroundResource(R.drawable.bg_dialog_bottom_center);
                    (layout.findViewById(R.id.viewLine)).setVisibility(View.GONE);
                }
            }

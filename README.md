...
/**
 * Created by ${qiuweizhong} on 2017/3/18.
 */
public class CustomDialog extends Dialog {
    private Context context;
    private int height, width;//dialog的大小
    private boolean cancelTouchout;//设置为false点击屏幕外面dialog就不会消失了
    private View view;//dialog的布局
...
然后使用
 ...
 CustomDialog.Builder builder1 = new CustomDialog.Builder(this);
                mBuild = builder1.cancelTouchout(false)
                        ...
                        .style(R.style.Dialog)//主题一般设置为透明的，不然，如果你的view设置了背景为圆角的，那么四个角就会显示一点dialog默认白色背景了
...
效果图
![image](https://github.com/DavidWeiZhong/-/blob/master/pic/QQ截图20170318170541.png)
